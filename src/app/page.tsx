  ...
  return (
    <div className="flex h-screen overflow-hidden bg-white">
      ...
      <div className="flex flex-col flex-1 min-w-0 h-full">
        {/* Top bar */}
        <header className="flex items-center justify-between h-14 px-4 border-b border-gray-200 bg-white flex-shrink-0 z-10">
          ...
          <div className="flex items-center gap-3">
            <a href="https://piyrox.sbs" target="_blank" rel="noopener noreferrer" className="text-xs text-gray-500 hover:text-gray-700 transition-colors">
              piyrox.sbs
            </a>
            {user ? (
                    ...
                    <div className="absolute right-0 top-full mt-2 w-64 bg-white border border-gray-200 rounded-lg shadow-lg z-50 overflow-hidden">
                      ...
                      <div className="p-2">
                        <button
                          ...
                          className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-100 transition-colors text-sm text-gray-700 hover:text-gray-900 w-full text-left"
                        >
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href="/signup"
                  className="px-4 py-2 rounded-lg text-sm font-medium bg-gray-900 hover:bg-gray-800 text-white transition-colors"
                >
                  Sign up
                </a>
              </div>
