    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', paddingTop: '70px' }}>
      <div className="glass-card" style={{ width: '100%', maxWidth: '400px' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{ color: '#888', fontSize: '0.9rem' }}>Sign in to your PIYROX account</p>
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '2rem', fontSize: '0.9rem', color: '#888' }}>
          Don't have an account? <a href="/register" style={{ color: '#fff', textDecoration: 'underline' }}>Register</a>
        </p>
      </div>
    </div>
  );
