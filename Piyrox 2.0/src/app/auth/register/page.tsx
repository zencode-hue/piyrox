      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 font-bold text-2xl">
            ...
            <span className="gradient-text">PIYROX</span>
          </Link>
        ...
        <div className="glass-card p-8">
          ...
          <button onClick={() => signIn("google", { callbackUrl: "/dashboard" })} className="btn-secondary w-full py-3 text-sm gap-3 mb-3">
          ...
          <button onClick={() => signIn("discord", { callbackUrl: "/dashboard" })} className="btn-secondary w-full py-3 text-sm gap-3" style={{ background: "rgba(88,101,242,0.1)", border: "1px solid rgba(88,101,242,0.2)" }}>
