  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl font-bold text-white mb-4">About PIYROX</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
        {[
          ...
          { icon: Users, title: "10,000+ Customers", desc: "Thousands of happy customers across 50+ countries trust PIYROX daily.", color: "text-blue-400" },
        ].map((item) => (
