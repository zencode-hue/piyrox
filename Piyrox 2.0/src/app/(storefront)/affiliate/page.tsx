...
export const metadata: Metadata = {
  ...
  description: "Earn commission on every sale you refer. Join the PIYROX affiliate program and start earning today.",
};
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="rounded-2xl p-8 mb-16" style={{ background: G, border: "1px solid rgba(245,158,11,0.12)" }}>
        <h2 className="text-xl font-bold text-white mb-6">Why Affiliate with PIYROX?</h2>
